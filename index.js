...
let key = "97d06b13740f1a05716a07d204ce5870";
let data;
let city;
...
function appendData(data) {
  ...
  border.style.boxShadow = "rgba(0, 0, 0, 0.24) 0px 3px 8px";
}
...
console.log(
  `https://api.openweathermap.org/data/2.5/forecast?lat=35&lon=139&appid=0197b72d4fdc61f77775a49831e8dd55&units=metric`
);
function error(err) {
